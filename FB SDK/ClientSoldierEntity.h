...
namespace fb
{
	...
	public:
		...
		void Update()
		{
			ClientAntAnimatableComponent* pSP = this->getComponent<ClientAntAnimatableComponent>("ClientAntAnimatableComponent");
			if(!pSP) return;
			pSP = (ClientAntAnimatableComponent*)&pSP[0];
			pSP->m_hadVisualUpdate= true;
			pSP = (ClientAntAnimatableComponent*)&pSP[1];
			pSP->m_hadVisualUpdate= true;
			this->m_visualTransformUpdated = 1;
		}
        ...
        {
            DWORD dwRet;
            DWORD ClientSoldierEntity_computeBoundingBox = COMPUTEAAB;// 0x00C67E60 ;//0x53B160;//124B690;
            __asm
            {
        ...
        {
            DWORD dwRet;
            DWORD ClientSoldierEntity_computeBoundingBoxWorldTransform = AABWORLDTRANSFORM;// 0x1248500;
            __asm
            {
                push trans
		...
		__forceinline bool UpdateBones()
		{
				...
				UpdateBonesFn UpdateBones = ( UpdateBonesFn ) dwUpdateBonesFn;
